...
module SafeYAML
  ...
  def self.using_psych?
    defined?(YAML::ENGINE) && YAML::ENGINE.yamler == 'psych'
  end

  def self.using_psych_1_9_3?
    self.using_psych? && RUBY_VERSION >= "1.9.3"
  end

  def self.using_psych_1_9_2?
    self.using_psych? && RUBY_VERSION == "1.9.2"
  end
end
...
module YAML
  ...
  elsif SafeYAML.using_psych_1_9_2?
    require "safe_yaml/psych_handler"
